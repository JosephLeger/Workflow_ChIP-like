...
${BOLD}DESCRIPTION${END}\n\
	...
	To perform spike normalization properly, skip 4_BowtieCheck.sh step and apply this script directly on unfiltered BAM files.\n\
...
# Initialize tmp_scaleFactor.csv file
