...
${BOLD}EXAMPLE USAGE${END}\n\
        sh ${script_name} HOMER/Peaks /LAB-DATA/BiRD/users/${usr}/Ref/Genome/Mus_musculus.GRCm39.dna_sm.primary_assembly.fa /LAB-DATA/BiRD/users/${usr}/Ref/Genome/Mus_musculus.GRCm39.108.gtf /LAB-DATA/BiRD/users/jleger/Ref/Motifs/NFIL3_Known.motif\n"
}
